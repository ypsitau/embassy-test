...
async fn main(_spawner: Spawner) {
    ...
    multiwrite_bytes(&mut flash, rp::flash::ERASE_SIZE as u32);

    background_read(&mut flash, (rp::flash::ERASE_SIZE * 2) as u32).await;

    loop {}
}

fn multiwrite_bytes(flash: &mut rp::flash::Flash<'_, rp::peripherals::FLASH, rp::flash::Async, FLASH_SIZE>, offset: u32) {
    ...
    defmt::unwrap!(flash.blocking_erase(ADDR_OFFSET + offset, ADDR_OFFSET + offset + rp::flash::ERASE_SIZE as u32));
...
fn erase_write_sector(flash: &mut rp::flash::Flash<'_, rp::peripherals::FLASH, rp::flash::Async, FLASH_SIZE>, offset: u32) {
...
async fn background_read(flash: &mut rp::flash::Flash<'_, rp::peripherals::FLASH, rp::flash::Async, FLASH_SIZE>, offset: u32) {
